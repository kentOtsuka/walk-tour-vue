<template>
  <v-card>
    <h2 class="d-flex align-center justify-center py-3">利用規約</h2>
    <v-divider />
    <v-col>
      <v-responsive :aspect-ratio="16 / 9">
        <div class="px-lg-4 px-md-3 px-sm-2">
          <p class="mb-1">
            この利用規約（以下、「本規約」といいます。）は、このウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。本サービスのご利用ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
          </p>
          <br />
          <h3>第1条 適用</h3>
          <ol>
          ...
          <ol>
            ...
            <ul>
              <li>
                Webカメラで撮影した画像の視聴に使用するPC、スマートフォン等の利用環境について生じた一切の不具合
              </li>
