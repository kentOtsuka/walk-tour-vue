<template>
  <v-card>
    <h2 class="d-flex align-center justify-center py-3">プライバシーポリシー</h2>
    <v-divider />
    <v-col>
      <v-responsive :aspect-ratio="16 / 9">
        <div class="px-lg-4 px-md-3 px-sm-2">
          ...
          <h3>アクセス解析ツール</h3>
          <p class="mb-1">
            本サービスは、お客様のアクセス解析のために、「Googleアナリティクス」を利用しています。Googleアナリティクスは、トラフィックデータの収集のためにCookieを使用しています。トラフィックデータは匿名で収集されており、個人を特定するものではありません。Cookieを無効にすれば、これらの情報の収集を拒否することができます。詳しくはお使いのブラウザの設定をご確認ください。Googleアナリティクスについて、詳しく<a
          ...
          <h3>お問い合わせ</h3>
          <p>
            ご意見、ご要望、情報の訂正、利用停止、ユーザー情報の削除などをご希望の場合は、<a
